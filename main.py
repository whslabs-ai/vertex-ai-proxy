...
async def chat_completions(request: Request):
    return await forward_request(request, "endpoints/openapi/v1/chat/completions")

@app.post("/v1/completions")
async def completions(request: Request):
    return await forward_request(request, "endpoints/openapi/v1/completions")

@app.post("/v1/embeddings")
async def embeddings(request: Request):
    return await forward_request(request, "endpoints/openapi/v1/embeddings")
